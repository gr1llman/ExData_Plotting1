plot2 <- function() {
        ...
        #  2. Ensure this function has been loaded into your R session. e.g. source("rplot2")
        #
        # When you have sourced the function you can execute it with no parameters e.g. rplot2()
        ...
        # Create a vector for the Global Active Power
        ...
        # Generate the plot - type is l for line, no xlabel
